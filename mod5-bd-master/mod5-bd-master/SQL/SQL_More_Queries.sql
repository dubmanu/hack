...
-- 165. List out the Name, Job, Salary of the emps in the department with the highest average salary.List out the Name, Job, Salary of the emps in the department with the highest average salary.O
...
-- 208. List the empno,ename,sal,job,deptno&exp of all the emps belongs to dept 10 or 20 with an exp 6 to 10 y working under the same mgr with out comm. With a job not ending irrespective of the position with comm.>200 with exp>=7y and sal<2500 but not belongs to the month sep or nov workingList the empno,ename,sal,job,deptno&exp of all the emps belongs to dept 10 or 20 with an exp 6 to 10 y working under the same mgr with out comm. With a job not ending irrespective of the position with comm.>200 with exp>=7y and sal<2500 but not belongs to the month sep or nov workingOunder the mgr whose no is not having digits either 9 or 0 in the asc dept& desc dept 
